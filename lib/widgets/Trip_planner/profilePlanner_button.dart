...
// Example Usage
class TripPlannerDetailScreen extends StatelessWidget {
  const TripPlannerDetailScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Trip Planner Details'),
        backgroundColor: Colors.white,
        elevation: 0,
      ),
      body: Padding(
...
// Alternative: Using ProfileCustomButton individually
class ProfileCustomButtonExample extends StatelessWidget {
  const ProfileCustomButtonExample({Key? key}) : super(key: key);
